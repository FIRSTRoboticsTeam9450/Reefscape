...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = Constants.robotConfig.getSteerGains();
    // When using closed-loop control, the drive motor uses the control
    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
    private static final Slot0Configs driveGains = Constants.robotConfig.getDriveGains();
    ...
    private static final TalonFXConfiguration driveInitialConfigs = new TalonFXConfiguration()
        .withCurrentLimits(
            new CurrentLimitsConfigs()
                .withStatorCurrentLimit(Amps.of(120)) //was 60, changed to be 120. idk if it was the right thing to change
    ...
    private static final double kCoupleRatio = 3.571;

    private static final double kDriveGearRatio = 6.75;   //L2+: 5.902777777777778, curently using L2: 6.75
    ...
    private static final Angle kFrontLeftEncoderOffset = Constants.robotConfig.getFrontLeftOffset();
    ...
    private static final Angle kFrontRightEncoderOffset = Constants.robotConfig.getFrontRightOffset();
    ...
    private static final Angle kBackLeftEncoderOffset = Constants.robotConfig.getBackLeftOffset();
    ...
    private static final Angle kBackRightEncoderOffset = Constants.robotConfig.getBackRightOffset();
